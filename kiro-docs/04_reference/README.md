...
| # | ファイル | 内容 | 公式情報源 | 公式更新日 |
|---|--------|------|----------|----------|
| 01 | [Settings](01_settings.md) | 全設定項目（公式8カテゴリ）と環境変数 | https://kiro.dev/docs/cli/reference/settings/ | 2026-05-19 |
| 02 | [Slash Commands](02_slash-commands.md) | 全スラッシュコマンド（36種）とキーボードショートカット | https://kiro.dev/docs/cli/reference/slash-commands/ | 2026-05-19 |
...
- 本ディレクトリの各文書は **2026-05-24 時点** の情報に基づいています
...
- [機能詳細ガイド (01_features/)](../01_features/README.md) — 25機能の詳細解説
