...
**出典**: [Settings - Kiro CLI Documentation](https://kiro.dev/docs/cli/reference/settings/)（公式ページ最終更新: 2026-05-19）
...
| 設定 | 型 | 説明 | 例 |
|------|-----|------|-----|
| `chat.enableThinking` | boolean | thinking ツール有効化 | `kiro-cli settings chat.enableThinking true` |
...
- [Settings - Kiro CLI Documentation](https://kiro.dev/docs/cli/reference/settings/)（公式ページ最終更新: 2026-05-19）
