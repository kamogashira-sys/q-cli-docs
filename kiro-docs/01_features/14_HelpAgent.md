...
- **コマンド固有ヘルプ（v1.26.0）**: `/help --legacy <command>`で特定コマンドのヘルプ表示
...
### コマンド固有のレガシーヘルプ（v1.26.0以降）

v1.26.0以降、`/help --legacy <command>`で特定コマンドのヘルプを表示できます。
...
これにより、Help Agentに切り替えずに、特定コマンドの使用方法を確認できます。
