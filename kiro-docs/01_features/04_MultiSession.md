[ホーム](../README.md) > [機能詳細ガイド](README.md) > マルチセッション
...
### リファレンス（辞書）
- [04_reference/02_slash-commands.md](../04_reference/02_slash-commands.md) — `/chat`、`/session-id`、`/save`、`/load`、`/rewind` の正規仕様
- [04_reference/03_cli-commands.md](../04_reference/03_cli-commands.md) — `kiro-cli chat --resume` 等のセッション管理コマンド

### 関連機能
- [21. v2.4 New Commands](21_v24NewCommands.md) — `/rewind`（会話巻き戻し）
- [10. Conversation Compaction](10_ConversationCompaction.md) — 長時間セッションの圧縮
