...
現在は、公式 [Subagents - Tool availability](https://kiro.dev/docs/cli/chat/subagents/) が「**デフォルトサブエージェントはメインエージェントと同じ組み込みツールを持つ**」と明記しており、`grep`・`glob` もサブエージェント内で利用できます（2026-07-04 確認）。
