...
Kiro CLI公式サイト（[https://kiro.dev/cli/](https://kiro.dev/cli/)）の画面遷移とページ構成について詳細に解説します。Kiro CLIは、ターミナルでのプロンプトからコード、デプロイまでの流れを提供するAI駆動の開発ツールです。
...
### 本サイトでの対応文書
- [機能詳細ガイド](../01_features/README.md) — 32機能 + カテゴリ別ナビゲーション
