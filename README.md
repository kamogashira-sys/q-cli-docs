...
Kiro CLI v2.x 系では **Windows対応・Headless Mode・新TUI** を中心に大幅な機能拡張が行われ、**v2.8.0 では CLI v3（Early Access）** が登場、**v2.11.0〜v2.12.0 では MCP OAuth 認証管理・事前登録アプリ対応**が強化されました：

1. **[v2.12.1 / v2.12.0 / v2.11.0 MCP OAuth 認証管理・事前登録アプリ対応](kiro-docs/02_update/01_changelog.md)**（2026-07-09 / 07-09 / 07-02）
