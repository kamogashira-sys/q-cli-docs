...
├── 01_for-users/               # ユーザー向けドキュメント（81文書）
...
| カテゴリ | 文書数 | 割合 |
|---------|--------|------|
| 01_for-users | 81文書 | 64.3% |
| 02_for-developers | 11文書 | 8.7% |
| 03_for-community | 14文書 | 11.1% |
| 04_issues | 1文書 | 0.8% |
| 05_meta | 19文書 | 15.1% |
| **合計** | **126文書** | **100%** |
...
#### 02_features（機能説明）
- **目的**: Q CLIの各機能の詳細説明
- **内容**: Chat（メイン + 8分類詳細）、Agent、オートコンプリート、キーボードショートカット、Knowledge、SSH、実験的機能
- **文書数**: 16文書（メイン8 + チャットコマンド詳細8）
