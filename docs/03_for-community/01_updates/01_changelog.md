...
**主要な変更**:
- 📢 **Kiro CLI告知**: Kiro CLIアップデート告知機能を追加 - 既存ワークフロー継続、手動/自動更新対応 (#3433, #3452, #3454)
- 🔢 **告知調整**: Kiroアップデート告知の表示回数を2回から5回に変更 (#3457)
- 📦 **バージョン更新**: v1.19.7への更新 (#3453)

**詳細**: [v1.19.7リリースノート](https://github.com/aws/amazon-q-developer-cli/releases/tag/v1.19.7)
...
**主要な変更**:
- ⏪ **リバート**: マルチラインコードブロック検出ヒント機能をリバート - 右矢印キーの動作問題を修正 (#3439)
- 📦 **バージョン更新**: v1.19.6への更新 (#3440)
- 🐛 **バグ修正**: feed.jsonのリリース情報追加 (#3441)

**詳細**: [v1.19.6リリースノート](https://github.com/aws/amazon-q-developer-cli/releases/tag/v1.19.6)
...
**主要な変更**:
- 💡 **UI改善**: マルチラインコードブロック検出にヒント機能を追加 (#3327)
- 🏷️ **ブランディング統一**: 使用状況表示のブランド名を「Q responses」に統一 (#3427)
- 📦 **バージョン更新**: v1.19.5への更新とビルド設定の調整 (#3428)

**詳細**: [v1.19.5リリースノート](https://github.com/aws/amazon-q-developer-cli/releases/tag/v1.19.5)
