...
詳細は[開発環境セットアップガイド](../for-developers/contributing/development-setup.md)を参照。
...
詳細は[PRガイドライン](../for-developers/contributing/pull-request-guide.md)を参照。
...
- [開発環境セットアップ](../for-developers/contributing/development-setup.md)
- [PRガイドライン](../for-developers/contributing/pull-request-guide.md)
- [アーキテクチャ概要](../for-developers/architecture/overview.md)
