...
| 9 | [記憶管理ガイド](09_memory-management.md) ⭐ | 初級 | 短期記憶と長期記憶の違い / /compactコマンドの使い方 / フォルダごとの記憶管理 / 保存場所の説明 |
| 10 | [ワークフロー自動化](10_workflow-automation.md) | 中級〜上級 | Agent Hooksによる自動化 / 実践的な自動化パターン / スクリプト作成方法 / パフォーマンス最適化 |
...
### 初心者の方
1. [第10章: 記憶管理ガイド](09_memory-management.md) ⭐ - Q CLIの記憶の仕組みを理解
2. [第1章: コンテキストの本質](01_essence.md) - コンテキストの基本
3. [第2章: コンテキストの仕組みと管理](02_mechanism.md) - 基本を理解
4. [第5章: 実践ガイド](05_practical-guide.md) - 実際に設定してみる
