...
| 9 | [ワークフロー自動化](09_workflow-automation.md) | 中級〜上級 | Agent Hooksによる自動化 / 実践的な自動化パターン / スクリプト作成方法 / パフォーマンス最適化 |
| 10 | [記憶管理ガイド](09_memory-management.md) ⭐ | 初級 | 短期記憶と長期記憶の違い / /compactコマンドの使い方 / フォルダごとの記憶管理 / 保存場所の説明 |
