...
- Amazon Q CLIの基本的な理解があると役立ちます
- [クイックスタート](02_quick-start.md)を完了していることを推奨

---

## ✅ インストール確認

料金プランを選択する前に、Q CLIを試してみることをお勧めします。

```bash
q --version
```

まだインストールしていない場合は、[インストールガイド](01_installation.md)を参照してください。
