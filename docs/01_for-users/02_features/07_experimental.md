[ホーム](../../README.md) > [ユーザーガイド](../README.md) > [機能ガイド](README.md) > 07 Experimental
...
> **Note**: 本サイトではv1.13.0以降の実験的機能を対象に記述しています。
> 各機能の導入バージョンは個別に記載しています。
...
- **状態の永続化**: 実行状態は `.amazonq/.subagents/` に保存
