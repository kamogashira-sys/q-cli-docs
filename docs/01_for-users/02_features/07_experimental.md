...
| Introspect Tool | ベータ | Q CLI自己認識 | ★★★☆☆ | 中 | 中級者以上 | v1.15.0+ |
| To-Do List | アルファ | タスク管理 | ★★★☆☆ | 低 | すべて | v1.15.0+ |
| Agent Delegate Tool | アルファ | バックグラウンドエージェント | ★★☆☆☆ | 高 | 上級者のみ | v1.18.0+ |
| Context Usage Indicator | ベータ | パフォーマンス監視 | ★★★★★ | 低 | すべて | v1.17.0+ |
| Checkpoint | ベータ | 作業状態の保存・復元 | ★★★★☆ | 中 | 中級者以上 | v1.17.0+ |
| Thinking | アルファ | デバッグ・学習 | ★★★☆☆ | 中 | 中級者以上 | - |
| Delegate Tool | アルファ | バックグラウンドタスク管理 | ★★☆☆☆ | 高 | 上級者のみ | - |
